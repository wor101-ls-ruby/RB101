...
puts array2  # the elements of array2 still point to the same memory location as the elements of array1. Therefore array2 will have upcased 'CURLY' and 'SHEMP' strings as well